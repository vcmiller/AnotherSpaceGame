...
namespace SBR {
    ...
    public abstract class CharacterNavigator : StateMachine {
        ...
        public override void GetInput() {
            ...
            if ((!agent.pathPending && !agent.hasPath) || agent.remainingDistance <= acceptance || agent.desiredVelocity.magnitude < 0.1f) {
        ...
        public void MoveTo(Vector3 destination, bool immediately) {
            if (immediately) {
                waypoints.Clear();
